  ...
  return (
    <div className="w-5/6 lg:h-[100dvh] mx-auto  flex items-center">
      <div className="flex flex-col md:flex-row gap-8 ">
        ...
        {/* Description Box */}
        <div className="flex-1 flex flex-col lg:mt-5 bg-amber-300">
          <div className="">
            <h1 className="text-primary text-4xl font-bold">Ehelepola Walawwa: Echoes of Royalty, Crafted for Today’s World</h1>
          </div>
