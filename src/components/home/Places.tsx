    ...
    <div className="w-5/6 lg:h-5/6 mx-auto items-center">
      <div className="flex flex-col md:flex-row gap-16 ">
        ...
        <div className="flex-1 flex flex-col lg:mt-5">
          <div className="">
            <h1 className="text-primary  leading-12 text-[52px] font-extrabold tracking-[0.8rem]">Legacy Meets,  <br /> <span className="text-8xl text-ternary tracking-normal">Luxury</span> </h1>
          </div>
