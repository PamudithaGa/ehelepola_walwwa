  ...
  const sendReservation = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    emailjs
      ...
      .then(
        () => {
          toast.success(
            "Reservation submitted successfully and confirmation sent to your mail. We'll get back to you!",
            {
              duration: 8000,
            }
          );
        ...
        (error) => {
          ...
          toast.error(
            "Oops! Something went wrong while submitting the reservation."
          );
        }
      );
  };
          ...
          <div className="flex gap-10 lg:gap-1 p-3 flex-col lg:flex-row w-full">
            ...
            <div className="lg:w-1/3 w-full md:w-full mt-0 md:mt-15 lg:mt-0">
              ...
              <p className="mb-3 text-gray-500">
                Secure your group’s visit to our museum by booking your
                preferred time slot in advance. Reservations are essential to
                manage daily capacity and ensure the best experience for all
                visitors.
              </p>

              <p className="mb-3 text-gray-300">
                Only 500 students allowed per day, reserve early to guarantee
                your spot!
              </p>
              ...
              <LocalizationProvider dateAdapter={AdapterDayjs}>
                ...
                >
                  ...
                  <TextField
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) => {
                      ...
                      if (value.length !== 10) {
                        setCnError(true);
                        setCnHelperText(
                          "Contact number must be 9 digits. ex - 077XXXXXXX"
                        );
                      } else {
                        setCnError(false);
                        setCnHelperText("");
                  ...
                  <TextField
                    ...
                    onChange={(e) => {
                      ...
                      if (value < 1 || value > 250 || isNaN(value)) {
                        setError(true);
                        setHelperText(
                          "Student count must be between 1 and 250"
                        );
                      } else {
                        setError(false);
                        setHelperText("");
                  ...
                  >
                    ...
                    <MenuItem value="9.00 AM - 11.00 AM">
                      9.00 AM - 11.00 AM
                    </MenuItem>
                    <MenuItem value="1.00 PM - 3.00 PM">
                      1.00 PM - 3.00 PM
                    </MenuItem>
                  </TextField>
