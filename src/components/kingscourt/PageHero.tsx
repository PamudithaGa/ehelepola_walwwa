      ...
      <section className="bg-black w-full flex items-baseline-last justify-center lg:h-[90dvh] h-[100dvh]">
        ...
        <div className=" lg:w-1/2 lg:h-full mt-20  pt-10">
          ...
          <p className="text-[15px] text-white/30 mt-5 mb-10 text-justify lg:pr-10">
              The Kings Court colonial-era prison was transformed into a
              distinctive shopping destination, blending history, architecture,
              and modern retail. While preserving elements of its original
              design, the space seamlessly integrated luxury boutiques, artisan
              shops, and art galleries, creating a unique commercial and
              cultural experience. High-end brands contrasted with the historic
              setting, while local craftsmen showcased handmade goods, keeping
              the heritage alive.
            </p>
